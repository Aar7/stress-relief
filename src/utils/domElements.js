...
export const submitRatingBtn = document.getElementById("submitRating-Btn");

export const countdownDisplay = document.querySelector("#countdownDisplay");
export const startBtn = document.getElementById("startTimer-Btn");
